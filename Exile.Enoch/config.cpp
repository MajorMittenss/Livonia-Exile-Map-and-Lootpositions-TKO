...
class CfgExileArsenal
{
    ...
    class srifle_CZ550_shit_2						{ quality = 3; price = 1500; };
	class srifle_CZ550_shit_1						{ quality = 3; price = 1500; };
	class arifle_MSBS65_F							{ quality = 3; price = 1500; };
	class arifle_MSBS65_Mark_F						{ quality = 3; price = 1500; };
	class arifle_MSBS65_GL_F						{ quality = 3; price = 1500; };
	class arifle_MSBS65_UBS_F						{ quality = 3; price = 1500; };
	class arifle_MSBS65_black_F						{ quality = 3; price = 1500; };
	class arifle_MSBS65_Mark_black_F				{ quality = 3; price = 1500; };
	class arifle_MSBS65_GL_black_F					{ quality = 3; price = 1500; };
	class arifle_MSBS65_UBS_black_F					{ quality = 3; price = 1500; };
	class arifle_MSBS65_sand_F						{ quality = 3; price = 1500; };
	class arifle_MSBS65_Mark_sand_F					{ quality = 3; price = 1500; };
	class arifle_MSBS65_GL_sand_F					{ quality = 3; price = 1500; };
	class arifle_MSBS65_UBS_sand_F					{ quality = 3; price = 1500; };
	class arifle_MSBS65_camo_F						{ quality = 3; price = 1500; };
	class arifle_MSBS65_Mark_camo_F					{ quality = 3; price = 1500; };
	class arifle_MSBS65_GL_camo_F					{ quality = 3; price = 1500; };
	class arifle_MSBS65_UBS_camo_F					{ quality = 3; price = 1500; };
	class sgun_HunterShotgun_01_F 					{ quality = 1; price = 1400; };
	class sgun_HunterShotgun_01_sawedoff_F 			{ quality = 1; price = 1400; };
	class srifle_DMR_06_hunter_F					{ quality = 6; price = 8000; };
	class arifle_AK12U_lush_F						{ quality = 2; price = 2500; };
	class arifle_AK12U_arid_F						{ quality = 2; price = 2500; };
	class arifle_AK12U_F							{ quality = 2; price = 2500; };
	class arifle_RPK12_F							{ quality = 3; price = 2900; };
	class arifle_RPK12_lush_F						{ quality = 3; price = 2900; };
	class arifle_RPK12_arid_F						{ quality = 3; price = 2900; };
	class arifle_AK12_lush_F						{ quality = 3; price = 2900; };
	class arifle_AK12_arid_F						{ quality = 3; price = 2900; };
	class arifle_AK12_GL_lush_F						{ quality = 3; price = 2900; };
	class arifle_AK12_GL_arid_F						{ quality = 3; price = 2900; };
	class LMG_Mk200_black_F							{ quality = 5; price = 5700; };
	class optic_ico_01_f 							{ quality = 1; price = 100; };
	class optic_ico_01_black_f						{ quality = 1; price = 100; };
	class optic_ico_01_sand_f						{ quality = 1; price = 100; };
	class optic_ico_01_camo_f						{ quality = 1; price = 100; };
	...
	class 2Rnd_12Gauge_Pellets						{ quality = 1; price = 30; };
	class 2Rnd_12Gauge_Slug							{ quality = 1; price = 40; };
	class 30Rnd_762x39_AK12_Mag_F 					{ quality = 3; price = 50; };
	class 75rnd_762x39_AK12_Mag_F					{ quality = 5; price = 100; };
	class 75rnd_762x39_AK12_Lush_Mag_F				{ quality = 5; price = 100; };
	class 75rnd_762x39_AK12_Lush_Mag_Tracer_F		{ quality = 5; price = 100; };
	class 75rnd_762x39_AK12_Arid_Mag_F				{ quality = 5; price = 100; };
	class 75rnd_762x39_AK12_Arid_Mag_Tracer_F		{ quality = 5; price = 100; };
	class 30rnd_762x39_AK12_Lush_Mag_F				{ quality = 4; price = 50; };
	class 30rnd_762x39_AK12_Arid_Mag_Tracer_F		{ quality = 4; price = 50; };
	class 30rnd_762x39_AK12_Arid_Mag_F				{ quality = 4; price = 50; };
	class 30rnd_762x39_AK12_Lush_Mag_Tracer_F		{ quality = 4; price = 50; };
	class 30Rnd_65x39_caseless_khaki_mag			{ quality = 4; price = 50; };
	class 30Rnd_65x39_caseless_khaki_mag_Tracer		{ quality = 4; price = 50; };
	class 100Rnd_65x39_caseless_khaki_mag			{ quality = 6; price = 400; };
	class 100Rnd_65x39_caseless_khaki_mag_tracer	{ quality = 6; price = 400; };
	//Offroad
	class I_E_Offroad_01_F 			                { quality = 1; price = 24000; };
	class I_E_Offroad_01_covered_F					{ quality = 3; price = 34000; };
	class I_E_Offroad_01_comms_F				    { quality = 3; price = 35000; };
	class B_GEN_Offroad_01_covered_F				{ quality = 3; price = 40000; };
	class B_GEN_Offroad_01_comms_F				    { quality = 3; price = 40000; };
	class C_Offroad_01_covered_F					{ quality = 3; price = 33000; };
	class C_Offroad_01_comms_F						{ quality = 3; price = 36000; };
	//Quad
	class I_E_Quadbike_01_F						    { quality = 1; price = 5900; };
	//Trekker
	class C_Tractor_01_F						    { quality = 1; price = 2900; };
	//Zamak
	class I_E_Truck_02_transport_F					{ quality = 3; price = 55000; };
	class I_E_Truck_02_fuel_F						{ quality = 5; price = 45000; };
	class I_E_Truck_02_Ammo_F						{ quality = 6; price = 80000; };
	class I_E_Truck_02_Box_F						{ quality = 3; price = 49000; };
	class I_E_Truck_02_Medical_F 					{ quality = 1; price = 45000; };
	class I_E_Truck_02_MRL_F						{ quality = 4; price = 55000; };
	//Van
	class I_E_Van_02_vehicle_F						{ quality = 2; price = 32000; };
	class I_E_Van_02_transport_MP_F					{ quality = 3; price = 35000; };
	class I_E_Van_02_medevac_F						{ quality = 1; price = 32000; };
	class I_E_Heli_light_03_unarmed_F				{ quality = 3; price = 100000; };
	class I_E_APC_tracked_03_cannon_F				{ quality = 6; price = 550000; };	
	//ED-1D Pelter
	//class I_UGV_02_Science_F						{ quality = 5; price = 80000; };
	//class I_E_UGV_02_Science_F					    { quality = 5; price = 80000; };
	//class I_UGV_02_Demining_F						{ quality = 5; price = 80000; };
	//class I_E_UGV_02_Demining_F				        { quality = 5; price = 80000; };
	//class C_IDAP_UGV_02_Demining_F				    { quality = 5; price = 80000; };

	class B_CombinationUnitRespirator_01_F 	     { quality = 3; price = 3000; };
	class B_SCBA_01_F 	                         { quality = 3; price = 2000; };
	//class B_UGV_02_Science_backpack_F 	         { quality = 6; price = 80000; };
	//class B_UGV_02_Demining_backpack_F 	         { quality = 6; price = 80000; };
	//class O_UGV_02_Science_backpack_F 	         { quality = 6; price = 80000; };
	//class O_UGV_02_Demining_backpack_F 	         { quality = 6; price = 80000; };
	//class I_UGV_02_Science_backpack_F 	         { quality = 6; price = 80000; };
	class I_E_UGV_02_Demining_backpack_F 	     { quality = 6; price = 150000; }; //drohne Bewaffnet
	//class I_UGV_02_Demining_backpack_F 	         { quality = 6; price = 80000; };
	class I_E_UGV_02_Science_backpack_F 	     { quality = 6; price = 80000; }; //Drohne Cam
	//class C_IDAP_UGV_02_Demining_backpack_F 	 { quality = 6; price = 80000; };
	//class I_E_UAV_01_backpack_F 	             { quality = 6; price = 80000; };
	class I_E_UAV_06_backpack_F 	             { quality = 6; price = 80000; }; //FLUG DROHNE
	//class I_E_UAV_06_medical_backpack_F 	     { quality = 5; price = 80000; };
	//class C_UAV_06_medical_backpack_F 	         { quality = 5; price = 80000; };
	//class C_IDAP_UAV_06_medical_backpack_F 	     { quality = 5; price = 80000; };
	//class I_UAV_06_medical_backpack_F 	         { quality = 5; price = 80000; };
	//class O_UAV_06_medical_backpack_F 	         { quality = 5; price = 80000; };
	//class B_UAV_06_medical_backpack_F 	         { quality = 5; price = 80000; };
	//class C_IDAP_UAV_06_antimine_backpack_F 	 { quality = 6; price = 80000; };
	//class C_UAV_06_backpack_F 	                 { quality = 5; price = 80000; };
	//class C_IDAP_UAV_06_backpack_F 	             { quality = 3; price = 80000; };

	class I_E_UavTerminal 	                     { quality = 5; price = 10000; };
	//class C_UavTerminal 	                     { quality = 5; price = 10000; };

	class H_Hat_Safari_sand_F 	                 { quality = 1; price = 250; };
	class H_Hat_Safari_olive_F 	                 { quality = 1; price = 250; };
	class H_HeadBandage_stained_F 	             { quality = 1; price = 150; };
	class H_HeadBandage_clean_F 	             { quality = 1; price = 150; };
	class H_HeadBandage_bloody_F 	             { quality = 1; price = 150; };
	class H_WirelessEarpiece_F 	                 { quality = 1; price = 100; };
	class H_Hat_Tinfoil_F 	                     { quality = 1; price = 199; };              //Aluhut

	class U_C_IDAP_Man_cargo_F 	                 { quality = 1; price = 500; };
	class U_C_IDAP_Man_Tee_F 	                 { quality = 1; price = 500; };
	class U_C_IDAP_Man_casual_F 	             { quality = 1; price = 800; };
	class U_C_IDAP_Man_shorts_F 	             { quality = 1; price = 800; };
	class U_C_IDAP_Man_Jeans_F 	                 { quality = 1; price = 800; };	
	class U_C_IDAP_Man_TeeShorts_F 	             { quality = 1; price = 800; };	

	
	class U_C_Paramedic_01_F 	                 { quality = 1; price = 500; };
	class U_C_Mechanic_01_F 	                 { quality = 1; price = 500; };
	class U_I_E_Uniform_01_F 	                 { quality = 1; price = 800; };
	class U_I_E_Uniform_01_tanktop_F 	         { quality = 1; price = 800; };
	class U_I_E_Uniform_01_shortsleeve_F 	     { quality = 1; price = 800; };
	class U_I_E_Uniform_01_officer_F 	         { quality = 1; price = 800; };
	class U_I_E_Uniform_01_coveralls_F 	         { quality = 1; price = 800; };
	class U_I_E_Uniform_01_sweater_F 	         { quality = 1; price = 800; };
	class U_O_R_Gorka_01_F 	                     { quality = 5; price = 2000; };
	class U_O_R_Gorka_01_brown_F 	             { quality = 5; price = 2000; };
	class U_O_R_Gorka_01_camo_F 	             { quality = 5; price = 2000; };
	class U_O_R_Gorka_01_black_F 	             { quality = 5; price = 2000; };
	class U_B_CombatUniform_vest_mcam_wdl_F 	 { quality = 4; price = 800; };
	class U_B_CombatUniform_mcam_wdl_F 	         { quality = 4; price = 800; };
	class U_B_CombatUniform_tshirt_mcam_wdL_F 	 { quality = 4; price = 800; };
	class U_B_CBRN_Suit_01_MTP_F 	             { quality = 1; price = 800; };
	class U_B_CBRN_Suit_01_Tropic_F 	         { quality = 1; price = 800; };
	class U_B_CBRN_Suit_01_Wdl_F 	             { quality = 1; price = 800; };
	class U_I_CBRN_Suit_01_AAF_F 	             { quality = 1; price = 800; };
	class U_I_E_CBRN_Suit_01_EAF_F 	             { quality = 1; price = 800; };
	class U_C_CBRN_Suit_01_Blue_F 	             { quality = 1; price = 800; };
	class U_C_CBRN_Suit_01_White_F 	             { quality = 1; price = 800; };
	class U_C_Uniform_Farmer_01_F 	             { quality = 1; price = 500; };
	class U_C_E_LooterJacket_01_F 	             { quality = 1; price = 500; };
	class U_C_Uniform_Scientist_01_F 	         { quality = 1; price = 500; };
	class U_C_Uniform_Scientist_01_Formal_F 	 { quality = 1; price = 500; };
	class U_C_Uniform_Scientist_02_F 	         { quality = 1; price = 500; };
	class U_C_Uniform_Scientist_02_Formal_F 	 { quality = 1; price = 500; };
	class U_I_L_Uniform_01_camo_F 	             { quality = 1; price = 500; };
	class U_I_L_Uniform_01_deserter_F 	         { quality = 1; price = 500; };
	class U_I_L_Uniform_01_tshirt_skull_F 	     { quality = 1; price = 500; };
	class U_I_L_Uniform_01_tshirt_black_F 	     { quality = 1; price = 500; };
	class U_I_L_Uniform_01_tshirt_sport_F 	     { quality = 1; price = 500; };
	class U_I_L_Uniform_01_tshirt_olive_F 	     { quality = 1; price = 500; };

	class V_CarrierRigKBT_01_Olive_F 	         { quality = 1; price = 500; };
	class V_CarrierRigKBT_01_heavy_EAF_F 	     { quality = 1; price = 500; };
	class V_CarrierRigKBT_01_light_EAF_F 	     { quality = 1; price = 500; };
	class V_CarrierRigKBT_01_EAF_F 	             { quality = 1; price = 500; };
	class V_CarrierRigKBT_01_light_Olive_F 	     { quality = 1; price = 500; };
	class V_CarrierRigKBT_01_heavy_Olive_F 	     { quality = 1; price = 500; };
	class V_SmershVest_01_F 	                 { quality = 1; price = 500; };
	class V_SmershVest_01_radio_F                { quality = 6; price = 500; };	
	//new CONTACT		
};
...
class CfgTraderCategories
{
	...
	class AlienHardwareWare
	{
		name = "Alien Hard Ware";
		icon = "a3\ui_f\data\gui\Rsc\RscDisplayArsenal\itemacc_ca.paa";
		items[] = 
		{
				//new CONTACT
	...
	class AlienKlamotten
	{
		name = "Alien Klamotten";
		icon = "a3\ui_f\data\gui\Rsc\RscDisplayArsenal\itemacc_ca.paa";
		items[] = 
		{
				//new CONTACT
